            ...
            <div class="container">
                <div class="row-table">
                    <div class="col-cell header-logo">
                        <div class="logo-area">
                            <a href="index.html">
                                <img class="normal-logo" src="{{asset('assets/images/logo-red.png')}}" alt="logo">
                                <img class="sticky-logo" src="{{asset('assets/images/logo-red.png')}}" alt="logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-cell">
                            ...
                            <div class="main-menu">
                                <nav class="rs-menu hidden-md">
                                    <ul class="nav-menu">
                                        ...
                                        <li>
                                            <a href="blog.html">Document</a>
                                        </li>
                                        <li>
                                            <a href="blog.html">Compliance Report</a>
                                        </li>
                                        <li>
                    ...
                    <div class="col-cell" style="margin-right: -100px;">
                    ...
                    <ul class="sub-menu">
                        <li class="menu-item-has-children current-menu-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="index4.html">Roofing</a></li>
